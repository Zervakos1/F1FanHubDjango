/* contact.js
   Handles client-side validation for the Contact page.
   Enables the submit button only when the form is ready and shows a confirmation summary after submission.
*/
